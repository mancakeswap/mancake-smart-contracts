...
import { abi as MancakeV3PoolDeployerABI } from '@pancakeswap/v3-core/artifacts/contracts/MancakeV3PoolDeployer.sol/MancakeV3PoolDeployer.json'
...
import { abi as MancakeStableSwapFactoryABI } from '@pancakeswap/stable-swap/artifacts/contracts/MancakeStableSwapFactory.sol/MancakeStableSwapFactory.json'

import { abi as SmartRouterABI } from '@pancakeswap/smart-router/artifacts/contracts/SmartRouter.sol/SmartRouter.json'

import { abi as MancakeTokenABI } from '@pancakeswap/masterchef-v3/artifacts/contracts/MancakeToken.sol/MancakeToken.json'
...
async function main() {
  ...
  const v3factory = new ethers.Contract(core.V3Factory, MancakeV3FactoryABI, owner)
  const deployer = new ethers.Contract(core.V3PoolDeployer, MancakeV3PoolDeployerABI, owner)
  ...
  const stableSwapFactory = new ethers.Contract(ss.StableSwapFactory, MancakeStableSwapFactoryABI, owner)
  ...
  const mancakeToken = new ethers.Contract(mc.MancakeToken, MancakeTokenABI, owner)
  ...
  await tx.wait(5)
  console.log('MancakeToken setOwner:', tx.hash)
