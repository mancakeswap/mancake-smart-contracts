...
const PancakeStableSwapFactory = artifacts.require('stable-swap/contracts/MancakeStableSwapFactory.sol')
const PancakeStableSwapLPFactory = artifacts.require('stable-swap/contracts/MancakeStableSwapLPFactory.sol')
const PancakeStableSwapTwoPoolDeployer = artifacts.require('stable-swap/contracts/MancakeStableSwapTwoPoolDeployer.sol')
const PancakeStableSwapThreePoolDeployer = artifacts.require(
  'stable-swap/contracts/MancakeStableSwapThreePoolDeployer.sol'
)
const PancakeStableSwapTwoPool = artifacts.require('stable-swap/contracts/MancakeStableSwapTwoPool.sol')
const PancakeStableSwapThreePool = artifacts.require('stable-swap/contracts/MancakeStableSwapThreePool.sol')
...
const PancakeStableSwapInfo = artifacts.require('stable-swap/contracts/utils/MancakeStableSwapInfo.sol')
const LPToken = artifacts.require('stable-swap/contracts/MancakeStableSwapLP.sol')
...
const PancakeFactory = artifacts.require('exchange-protocol/contracts/MancakeFactory.sol')
const PancakePair = artifacts.require('exchange-protocol/contracts/MancakePair.sol')
const PancakeRouter = artifacts.require('exchange-protocol/contracts/MancakeRouter.sol')
