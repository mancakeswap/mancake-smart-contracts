...
import './MancakeStableSwapThreePool.sol';

contract MancakeStableSwapThreePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(MancakeStableSwapThreePool).creationCode;
        ...
        MancakeStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
