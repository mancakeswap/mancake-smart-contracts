...
import './MancakeStableSwapTwoPool.sol';

contract MancakeStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(MancakeStableSwapTwoPool).creationCode;
        ...
        MancakeStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
