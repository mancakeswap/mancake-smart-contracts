...
import './MancakeStableSwapLP.sol';

contract MancakeStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(MancakeStableSwapLP).creationCode;
        ...
        MancakeStableSwapLP(lpToken).setMinter(_minter);
