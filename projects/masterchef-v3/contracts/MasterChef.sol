...
contract MasterChef is Ownable {
    ...
    constructor(MancakeToken _cake, SyrupBar _syrup, address _devaddr, uint256 _cakePerBlock, uint256 _startBlock) {
        cake = _cake;
        syrup = _syrup;
        devaddr = _devaddr;
