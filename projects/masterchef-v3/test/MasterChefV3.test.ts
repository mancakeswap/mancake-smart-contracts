...
import PancakeV3PoolDeployerArtifact from "@pancakeswap/v3-core/artifacts/contracts/MancakeV3PoolDeployer.sol/MancakeV3PoolDeployer.json";
import PancakeV3FactoryArtifact from "@pancakeswap/v3-core/artifacts/contracts/MancakeV3Factory.sol/MancakeV3Factory.json";
...
describe("MasterChefV3", function () {
  ...
  beforeEach(async function () {
    ...
    // Deploy factory
    const MancakeV3PoolDeployer = await ethers.getContractFactoryFromArtifact(PancakeV3PoolDeployerArtifact);
    const pancakeV3PoolDeployer = await MancakeV3PoolDeployer.deploy();
